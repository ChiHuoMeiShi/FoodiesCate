...
//    tableView = [[UITableView alloc] initWithFrame:CGRectMake(  [UIScreen mainScreen].bounds.size.width - 80 , 70.0 -  20.0 * selectData.count , frame.size.width, 40 * selectData.count) style:0];
    tableView = [[UITableView alloc] initWithFrame:CGRectMake(80.f , 70.0 -  20.0 * selectData.count , frame.size.width, 40 * selectData.count) style:0];
//    tableView = [UITableView alloc] initWithFrame:CGRectMake(20.f, <#CGFloat y#>, <#CGFloat width#>, <#CGFloat height#>) style:<#(UITableViewStyle)#>
