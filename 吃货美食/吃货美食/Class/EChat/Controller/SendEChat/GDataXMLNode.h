...
enum {
    ParagraphType_Text,             //纯文本
    ParagraphType_ContainOther      //包含图片或者Video(视频)或者Audio(音频)
};
typedef NSUInteger ParagraphType;
